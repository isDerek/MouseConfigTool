...
void MouseConfigTool::setDisplayParams()
{
    int currentIndex;
...
void MouseConfigTool::on_clearRevDataBtn_clicked()
{
    ui->recvDataTextEdit->clear();
}

void MouseConfigTool::on_clearSendDataBtn_clicked()
{
    ui->sendDataTextEdit->clear();
}

void MouseConfigTool::on_sendDataBtn_clicked()
{
    QByteArray sendData;
