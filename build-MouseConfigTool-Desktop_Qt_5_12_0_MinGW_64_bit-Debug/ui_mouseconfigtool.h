...
public:
    ...
    void setupUi(QMainWindow *MouseConfigTool)
    {
        ...
        MouseConfigTool->resize(1339, 941);
        ...
        currentModeText = new QLabel(groupBox_13);
        ...
        gridLayout_4 = new QGridLayout(groupBox_15);
        ...
        updateHexName = new QLineEdit(groupBox_15);
        ...
        gridLayout_3->addWidget(groupBox_15, 5, 2, 1, 3);
        ...
        currentPowerText = new QLabel(groupBox_14);
        ...
        currentLEDText = new QLabel(groupBox_9);
        currentLEDText->setObjectName(QString::fromUtf8("currentLEDText"));

        verticalLayout_4->addWidget(currentLEDText);
        ...
        currentDPIText = new QLabel(groupBox_8);
    ...
    void retranslateUi(QMainWindow *MouseConfigTool)
    {
        ...
        label_14->setText(QApplication::translate("MouseConfigTool", "\346\226\207\344\273\266\350\267\257\345\276\204\357\274\232", nullptr));
